...
<head>
    ...
    <title>Ardennes Connect - Profil</title>
...
<body class="bg-darkGray h-screen flex flex-col gap-10">
    ...
    <main>
        ...
        <!-- HEADER -->
        <header class="container rounded-lg flex justify-center pb-8 mx-auto">

            <div class="bg-white rounded-lg shadow-xl pb-8">

                <div class="w-full h-[250px]">
                    <img src="https://vojislavd.com/ta-template-demo/assets/img/profile-background.jpg" class="w-full h-full rounded-lg">
                </div>
                ...
                <div class="flex flex-col items-center -mt-20">
                    ...
                    data-[not_active]:bg-[#dc2f34] data-[not_active]:text-white
                ...
                <div class="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
                    ...
                    <div class="flex items-center space-x-4 mt-2">
                        <button class="flex items-center bg-[#00abe7] hover:bg-[#004a93] text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                            <span>Modifier</span>
                        </button>

                        <button class="flex items-center bg-[#dc2f34] hover:bg-[#B60015] text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
        ...
        <!-- TABLE -->
        <section class="z-10 bg-white relative lg:bg-none">
            ...
            <div class="fixed bottom-0 left-0 flex justify-center w-full py-4 text-sm font-semibold tracking-wide uppercase rounded-tr-lg bg-white lg:static">
                ...
                <div class="flex mx-auto lg:w-2/5 xl:w-1/4 justify-between">
                    <a href="accueil" class="lg:hidden w-6 h-6 mr-1">
                        <img src="src/assets/svg/arrow.svg" alt="icons arrow">
                    </a>
                    <!-- QR CODE -->
        ...
        <section class="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
